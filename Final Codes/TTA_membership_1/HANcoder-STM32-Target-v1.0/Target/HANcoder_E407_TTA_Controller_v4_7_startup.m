...
Tx_bit_number = 4; % This is hardcoded in the Tx buffer update of the COMM tasks
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
TM_COMM_Output_Master   = TM_Check_Output_Control2 + COMM_duration; % COMP Check Output Controller 2
TM_Data_bc1(end+1)      = TM_COMM_Output_Master;
TM_Type_bc1(end+1)      = COMM;
TM_Check_Output_Master  = TM_COMM_Output_Master + COMM_duration;      % COMP Check Output Controller 2
TM_Data_bc1(end+1)       = TM_Check_Output_Master;
TM_Type_bc1(end+1)       = COMP;


% TMR
TM_TMR                   = TM_Check_Output_Master + COMP_duration;     % COMP TMR <update msg Out1>
...
TM_Type_bc1(end+1)       = COMP;
TM_Check_Output_Emulator_3 = TM_Check_Output_Emulator_2 + 2;               % <Vehicle Em.: Update msg>
TM_Data_bc1(end+1)       = TM_Check_Output_Emulator_3;
TM_Type_bc1(end+1)       = COMP;

% Reset variables
TM_Reset_Var_bc1         = TM_Check_Output_Emulator_3 + COMP_duration;     % COMP Check TimeOuts
