...
MODEL                = HANcoder_E407_CAN_COMM_TEST
MODULES              = 
MAKEFILE             = HANcoder_E407_CAN_COMM_TEST.mk
...
#|---------------------------------------------------------------------------------------
MODELLIB                  = HANcoder_E407_CAN_COMM_TESTlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I"C:\Users\Diego\Desktop\HAN\MAJORP~1\MP_Code\TTA_CO~1\HANCOD~1.0\Target\HANcoder_E407_CAN_COMM_TEST_ert_rtw" \
	-I"$(MATLAB_ROOT)\extern\include" \
	-I"$(MATLAB_ROOT)\simulink\include" \
	-I"$(MATLAB_ROOT)\rtw\c\src" \
