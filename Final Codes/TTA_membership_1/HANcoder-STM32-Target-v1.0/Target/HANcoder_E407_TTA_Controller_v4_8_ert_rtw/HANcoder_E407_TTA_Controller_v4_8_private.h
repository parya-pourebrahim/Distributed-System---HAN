 ...
 *
 * File: HANcoder_E407_TTA_Controller_v4_8_private.h
 *
...
#ifndef RTW_HEADER_HANcoder_E407_TTA_Controller_v4_8_private_h_
#define RTW_HEADER_HANcoder_E407_TTA_Controller_v4_8_private_h_
#include "rtwtypes.h"
...
extern void Receptionsubstasks(boolean_T rtu_Enable, real_T rtu_Time_Mark,
  ...
  *rtd_Msg_Rx_dt, boolean_T *rtd_New_Msg_Ready_CAN1, boolean_T
...
extern void COMMTaskSyncbc1(boolean_T rtu_Enable, real_T rtu_TimeMark,
  ...
  msg_buffer_type *rtd_Msg_Rx_dt, msg_buffer_type *rtd_Msg_Tx_CAN1,
  ...
  *rtd_Tx_msg_count_CAN1, real_T *rtd_Tx_msg_count_CAN2, uint8_T
  *rtd_basic_cycle_count, real_T *rtd_delta_a_est, real_T *rtd_delta_f_est,
  boolean_T *rtd_new_msg_Rx_b, real_T *rtd_speed_integral, real_T
  *rtd_torque_ar_integral, real_T *rtd_torque_fr_integral);
extern void CheckTimeouts(boolean_T rtu_Enable, boolean_T
  *rtd_BC0_Sync_processed, real_T *rtd_Sync_bc0_missed_counter_l, boolean_T
  *rtd_Toggle_Pin_A1);
extern void RESETBoardReturntoinitializatio(boolean_T rtu_Enable, const
  ...
  *rtd_Reset_Board_a, real_T *rtd_Role_ID, uint32_T *rtd_RxID_CAN1, uint32_T
...
extern void COMPTaskResetVariablesBC1(boolean_T rtu_Enable, real_T rtu_Time_Mark,
  boolean_T *rtd_BC0_Sync_processed, boolean_T *rtd_Desync_Positive, uint16_T
  *rtd_Local_Ticks, boolean_T *rtd_Toggle_Pin_A0);
extern void BitShift1_b(uint8_T rtu_u, rtB_BitShift1_p *localB);
...
extern void DemuxmessageCAN1andch_h_Disable(rtB_DemuxmessageCAN1andcheckc_e
  *localB, rtDW_DemuxmessageCAN1andcheck_n *localDW);
extern void DemuxmessageCAN1andcheckcoher_n(boolean_T rtu_Enable, const
  msg_buffer_type *rtu_CAN2_Rx_msg, real_T rtu_expected_basic_cycle,
  rtB_DemuxmessageCAN1andcheckc_e *localB, rtDW_DemuxmessageCAN1andcheck_n
  *localDW, real_T *rtd_msg_count_DEBUG_l);
...
extern void COMPTaskUpdateLT1(boolean_T rtu_Enable, real_T rtu_Time_Mark, real_T
  ...
  *rtd_Desync_Positive, real_T *rtd_Desync_Ticks, uint16_T *rtd_Local_Ticks,
  boolean_T *rtd_Reset_Board_a, boolean_T *rtd_Toggle_Pin_A0, boolean_T
  *rtd_Toggle_Pin_D10, boolean_T *rtd_new_msg_Rx_b);
...
extern void Transmissionsubtasks1(boolean_T rtu_Enable, real_T rtu_Time_Mark,
  ...
  rtDW_Transmissionsubtasks1 *localDW, real_T *rtd_Board_ID, uint16_T
  *rtd_Local_Ticks, msg_buffer_type *rtd_Msg_Tx_CAN1, msg_buffer_type
  *rtd_Msg_Tx_CAN2, uint32_T *rtd_TxID_CAN1, uint32_T *rtd_TxID_CAN2, real_T
  *rtd_Tx_msg_count_CAN1, real_T *rtd_Tx_msg_count_CAN2, uint8_T
...
extern void ResetVariables(boolean_T rtu_Enable, boolean_T
  ...
  *rtd_Toggle_Pin_A0);
extern void DemuxmessageCAN1andch_m_Disable(rtB_DemuxmessageCAN1andcheckc_j
  *localB, rtDW_DemuxmessageCAN1andcheck_a *localDW);
extern void DemuxmessageCAN1andcheckcoher_b(boolean_T rtu_Enable, const
  ...
  rtB_DemuxmessageCAN1andcheckc_j *localB, rtDW_DemuxmessageCAN1andcheck_a
  *localDW, real_T *rtd_msg_count_DEBUG_l);
extern void DemuxmessageCAN1andch_c_Disable(rtB_DemuxmessageCAN1andcheckc_b
  *localB, rtDW_DemuxmessageCAN1andcheck_i *localDW);
extern void DemuxmessageCAN1andcheckcoher_a(boolean_T rtu_Enable, const
  ...
  rtB_DemuxmessageCAN1andcheckc_b *localB, rtDW_DemuxmessageCAN1andcheck_i
  *localDW, real_T *rtd_msg_count_DEBUG_l);
extern void LocalTimeUpdate_p(boolean_T rtu_Enable, real_T rtu_Time_Mark,
...
extern void COMPTaskUpdateLT(boolean_T rtu_Enable, real_T rtu_Time_Mark, real_T
  ...
  *rtd_Desync_Positive, real_T *rtd_Desync_Ticks, uint16_T *rtd_Local_Ticks,
  boolean_T *rtd_Reset_Board_k, boolean_T *rtd_Toggle_Pin_A0, boolean_T
  *rtd_Toggle_Pin_D10, boolean_T *rtd_new_msg_Rx_pi);
...
extern void DemuxmessageCAN1andch_o_Disable(rtB_DemuxmessageCAN1andcheckc_g
  *localB, rtDW_DemuxmessageCAN1andcheck_m *localDW);
extern void DemuxmessageCAN1andcheckcoher_g(boolean_T rtu_Enable, const
  msg_buffer_type *rtu_CAN1_Rx_msg, real_T rtu_expected_basic_cycle, real_T
  rtu_expected_board_id, rtB_DemuxmessageCAN1andcheckc_g *localB,
  rtDW_DemuxmessageCAN1andcheck_m *localDW, real_T *rtd_msg_count_DEBUG_i);
...
extern void Transmissionsubtasks1_m_Disable(rtB_Transmissionsubtasks1_k *localB,
  rtDW_Transmissionsubtasks1_a *localDW);
extern void Transmissionsubtasks1_c(boolean_T rtu_Enable, real_T rtu_Time_Mark,
  rtB_Transmissionsubtasks1_k *localB, const rtC_Transmissionsubtasks1_a *localC,
  rtDW_Transmissionsubtasks1_a *localDW, real_T *rtd_Board_ID, boolean_T
...
#endif                                 /* RTW_HEADER_HANcoder_E407_TTA_Controller_v4_8_private_h_ */
