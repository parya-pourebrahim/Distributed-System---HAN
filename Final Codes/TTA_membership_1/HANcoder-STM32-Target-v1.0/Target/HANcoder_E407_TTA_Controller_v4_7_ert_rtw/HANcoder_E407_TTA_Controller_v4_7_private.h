 ...
 *
 * File: HANcoder_E407_TTA_Controller_v4_7_private.h
 *
...
#ifndef RTW_HEADER_HANcoder_E407_TTA_Controller_v4_7_private_h_
#define RTW_HEADER_HANcoder_E407_TTA_Controller_v4_7_private_h_
#include "rtwtypes.h"
...
extern void RXbuffersupdate(boolean_T rtu_Enable, const rtC_RXbuffersupdate
  *localC, msg_buffer_type *rtd_Msg_Rx_k, boolean_T *rtd_New_Msg_Ready_CAN1,
  boolean_T *rtd_New_Msg_Ready_CAN2, uint32_T *rtd_RxID_CAN1, uint32_T
  *rtd_RxID_CAN2, uint8_T *rtd_Rx_State_CAN1, uint8_T *rtd_Rx_State_CAN2,
  boolean_T *rtd_new_msg_Rx_pj);
...
extern void Receptionsubstasks(boolean_T rtu_Enable, real_T rtu_Time_Mark,
  ...
  *rtd_Msg_Rx_k, boolean_T *rtd_New_Msg_Ready_CAN1, boolean_T
...
extern void COMMTaskSyncbc0(boolean_T rtu_Enable, real_T rtu_TimeMark,
  ...
  msg_buffer_type *rtd_Msg_Rx_k, msg_buffer_type *rtd_Msg_Tx_CAN1,
  ...
  *rtd_Tx_msg_count_CAN1, real_T *rtd_Tx_msg_count_CAN2, uint8_T
  *rtd_basic_cycle_count, real_T *rtd_delta_a_est, real_T *rtd_delta_f_est,
  boolean_T *rtd_new_msg_Rx_pj, real_T *rtd_speed_integral, real_T
...
extern void RESETBoardReturntoinitializatio(boolean_T rtu_Enable, const
  rtC_RESETBoardReturntoinitializ *localC, boolean_T *rtd_Initialization_flag,
  real_T *rtd_Master_ID, boolean_T *rtd_New_Msg_Ready_CAN1, boolean_T
  *rtd_New_Msg_Ready_CAN2, boolean_T *rtd_Reset_Board_b, real_T *rtd_Role_ID,
  uint32_T *rtd_RxID_CAN1, uint32_T *rtd_RxID_CAN2, uint8_T *rtd_Rx_State_CAN1,
  uint8_T *rtd_Rx_State_CAN2, boolean_T *rtd_Toggle_Pin_A0);
extern void BitShift1_k(uint8_T rtu_u, rtB_BitShift1_n *localB);
...
extern void DemuxmessageCAN1andcheckcoheren(boolean_T rtu_Enable, const
  ...
  rtDW_DemuxmessageCAN1andcheckco *localDW, real_T *rtd_msg_count_DEBUG_l);
extern void DemuxmessageCAN1andch_j_Disable(rtB_DemuxmessageCAN1andcheckc_e
  *localB, rtDW_DemuxmessageCAN1andcheck_k *localDW);
extern void DemuxmessageCAN1andcheckcoher_b(boolean_T rtu_Enable, const
  msg_buffer_type *rtu_CAN2_Rx_msg, real_T rtu_expected_basic_cycle, real_T
  rtu_expected_board_id, rtB_DemuxmessageCAN1andcheckc_e *localB,
  rtDW_DemuxmessageCAN1andcheck_k *localDW, real_T *rtd_msg_count_DEBUG_l);
extern void Desynccalculation(boolean_T rtu_Enable, real_T rtu_TM_COMM,
  ...
  rtu_msg_count_CAN2, real_T *rtd_Desync_Ticks, uint16_T *rtd_Msg_Rx_Ticks_CAN1,
...
extern void COMPTaskUpdateLT(boolean_T rtu_Enable, real_T rtu_Time_Mark, real_T
  rtu_Time_Mark_2, boolean_T *rtd_BC0_Sync_processed, boolean_T
  *rtd_Desync_Positive, real_T *rtd_Desync_Ticks, uint16_T *rtd_Local_Ticks,
  boolean_T *rtd_Reset_Board_b, boolean_T *rtd_Toggle_Pin_A0, boolean_T
  *rtd_Toggle_Pin_D10, boolean_T *rtd_new_msg_Rx_pj);
extern void Receptionsubstasks_k_Disable(rtB_Receptionsubstasks_c *localB,
  rtDW_Receptionsubstasks_e *localDW);
extern void Receptionsubstasks_m(boolean_T rtu_Enable, real_T rtu_Time_Mark,
  rtB_Receptionsubstasks_c *localB, const rtC_Receptionsubstasks_a *localC,
  rtDW_Receptionsubstasks_e *localDW, uint16_T *rtd_Local_Ticks, msg_buffer_type
  *rtd_Msg_Rx_h, boolean_T *rtd_New_Msg_Ready_CAN1, boolean_T
  *rtd_New_Msg_Ready_CAN2, uint32_T *rtd_RxID_CAN1, uint32_T *rtd_RxID_CAN2,
  uint8_T *rtd_Rx_State_CAN1, uint8_T *rtd_Rx_State_CAN2, boolean_T
  *rtd_new_msg_Rx_e);
extern void COMMTaskSyncbc1_Disable(rtB_COMMTaskSyncbc1 *localB,
  rtDW_COMMTaskSyncbc1 *localDW);
extern void COMMTaskSyncbc1(boolean_T rtu_Enable, real_T rtu_TimeMark,
  rtB_COMMTaskSyncbc1 *localB, const rtC_COMMTaskSyncbc1 *localC,
  rtDW_COMMTaskSyncbc1 *localDW, real_T *rtd_Board_ID, uint16_T *rtd_Local_Ticks,
  msg_buffer_type *rtd_Msg_Rx_h, msg_buffer_type *rtd_Msg_Tx_CAN1,
  msg_buffer_type *rtd_Msg_Tx_CAN2, boolean_T *rtd_New_Msg_Ready_CAN1, boolean_T
  *rtd_New_Msg_Ready_CAN2, real_T *rtd_Role_ID, uint32_T *rtd_RxID_CAN1,
  uint32_T *rtd_RxID_CAN2, uint8_T *rtd_Rx_State_CAN1, uint8_T
  *rtd_Rx_State_CAN2, uint32_T *rtd_TxID_CAN1, uint32_T *rtd_TxID_CAN2, real_T
  *rtd_Tx_msg_count_CAN1, real_T *rtd_Tx_msg_count_CAN2, uint8_T
  *rtd_basic_cycle_count, real_T *rtd_delta_a_est, real_T *rtd_delta_f_est,
  boolean_T *rtd_new_msg_Rx_e, real_T *rtd_speed_integral, real_T
  *rtd_torque_ar_integral, real_T *rtd_torque_fr_integral);
extern void ResetVariables(boolean_T rtu_Enable, boolean_T
  *rtd_BC1_Sync_processed, boolean_T *rtd_Desync_Positive, boolean_T
  *rtd_Toggle_Pin_A0);
extern void COMPTaskResetVariablesBC2(boolean_T rtu_Enable, real_T rtu_Time_Mark,
  boolean_T *rtd_BC1_Sync_processed, boolean_T *rtd_Desync_Positive, uint16_T
  *rtd_Local_Ticks, boolean_T *rtd_Toggle_Pin_A0);
extern void DemuxmessageCAN1andch_k_Disable(rtB_DemuxmessageCAN1andcheckc_p
  *localB, rtDW_DemuxmessageCAN1andcheck_n *localDW);
extern void DemuxmessageCAN1andcheckcoher_e(boolean_T rtu_Enable, const
  ...
  rtB_DemuxmessageCAN1andcheckc_p *localB, rtDW_DemuxmessageCAN1andcheck_n
  *localDW, real_T *rtd_msg_count_DEBUG_l);
extern void DemuxmessageCAN1andch_d_Disable(rtB_DemuxmessageCAN1andcheckc_o
  *localB, rtDW_DemuxmessageCAN1andcheck_p *localDW);
extern void DemuxmessageCAN1andcheckcoher_f(boolean_T rtu_Enable, const
  msg_buffer_type *rtu_CAN2_Rx_msg, real_T rtu_expected_board_id,
  rtB_DemuxmessageCAN1andcheckc_o *localB, rtDW_DemuxmessageCAN1andcheck_p
  *localDW, real_T *rtd_msg_count_DEBUG_l);
extern void LocalTimeUpdate_o(boolean_T rtu_Enable, real_T rtu_Time_Mark,
...
extern void COMPTaskUpdateLT1(boolean_T rtu_Enable, real_T rtu_Time_Mark, real_T
  ...
  *rtd_Desync_Positive, real_T *rtd_Desync_Ticks, uint16_T *rtd_Local_Ticks,
  real_T *rtd_Role_ID, boolean_T *rtd_Toggle_Pin_A0, boolean_T
  *rtd_Toggle_Pin_D10, boolean_T *rtd_new_msg_Rx_e);
...
extern void BitShift1_l(uint8_T rtu_u, rtB_BitShift1_nt *localB);
...
extern void RESETBoardReturntoinitializat_d(boolean_T rtu_Enable, const
  rtC_RESETBoardReturntoinitial_e *localC, boolean_T *rtd_Desync_Positive,
...
extern void DemuxmessageCAN1andc_dy_Disable(rtB_DemuxmessageCAN1andcheckc_g
...
extern void DemuxmessageCAN1andcheckcoher_o(boolean_T rtu_Enable, const
  ...
  rtB_DemuxmessageCAN1andcheckc_g *localB, rtDW_DemuxmessageCAN1andcheck_f
  *localDW, real_T *rtd_msg_count_DEBUG_m);
...
extern void TTASystem(rtB_TTASystem *localB, const rtC_TTASystem *localC,
                      rtDW_TTASystem *localDW, real_T *rtd_Board_ID, uint8_T
                      *rtd_Flag_Broken, uint16_T *rtd_Local_Ticks, real_T
                      ...
                      *rtd_Tx_msg_count_CAN1, real_T *rtd_Tx_msg_count_CAN2,
                      uint8_T *rtd_broken_board_ID);

#endif                                 /* RTW_HEADER_HANcoder_E407_TTA_Controller_v4_7_private_h_ */
