...
MODEL                = HANcoder_E407_TTA_Controller_v4
MODULES              = HANcoder_E407_TTA_Controller_v4_data.c
MAKEFILE             = HANcoder_E407_TTA_Controller_v4.mk
...
#|---------------------------------------------------------------------------------------
MODELLIB                  = HANcoder_E407_TTA_Controller_v4lib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I"C:\Users\kkuijpers\Desktop\TTA_membership_1\HANcoder-STM32-Target-v1.0\Target\HANcoder_E407_TTA_Controller_v4_ert_rtw" \
	-I"$(MATLAB_ROOT)\extern\include" \
	-I"$(MATLAB_ROOT)\simulink\include" \
	-I"$(MATLAB_ROOT)\rtw\c\src" \
