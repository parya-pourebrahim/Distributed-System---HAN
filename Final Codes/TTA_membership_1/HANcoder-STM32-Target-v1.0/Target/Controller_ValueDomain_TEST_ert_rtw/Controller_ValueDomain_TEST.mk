...
MODEL                = Controller_ValueDomain_TEST
MODULES              = Controller_ValueDomain_TEST_data.c
MAKEFILE             = Controller_ValueDomain_TEST.mk
...
#|---------------------------------------------------------------------------------------
MODELLIB                  = Controller_ValueDomain_TESTlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	...
	-I"C:\Users\Diego\Desktop\HAN\MAJORP~1\MP_Code\TTA_CO~1\HANCOD~1.0\Target\Controller_ValueDomain_TEST_ert_rtw" \
	-I"$(MATLAB_ROOT)\extern\include" \
	-I"$(MATLAB_ROOT)\simulink\include" \
	-I"$(MATLAB_ROOT)\rtw\c\src" \
